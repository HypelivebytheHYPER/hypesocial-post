...
export async function GET(
  ...
  try {
    ...
    const q = parseQuery(ListFeedQuerySchema, {
      ...
      external_post_id:
        searchParams.getAll("external_post_id").length > 0
          ? searchParams.getAll("external_post_id")
          : undefined,
      social_post_id:
        searchParams.getAll("social_post_id").length > 0
          ? searchParams.getAll("social_post_id")
          : undefined,
      platform_post_id:
        searchParams.getAll("platform_post_id").length > 0
          ? searchParams.getAll("platform_post_id")
          : undefined,
    });
