...
export function WebhooksClient({ webhookEndpoint }: WebhooksClientProps) {
  ...
  // Extract subscribed events from webhooks
        ...
        <div className="relative">
          ...
          <div className="flex flex-col sm:flex-row items-center gap-4 sm:gap-0 justify-center py-6">
            ...
            >
              ...
              <span className="text-[10px] text-slate-400">Serverless</span>
            </motion.div>
          ...
          {isLoading ? (
            ...
            >
              ...
              <p className="text-slate-400 text-sm mt-1">
                Webhooks are managed directly on Vercel
              </p>
            </motion.div>
          ) : (
            <motion.div
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex flex-wrap gap-1.5">
                      {webhook.event_types.map((event) => {
                        ...
                        const meta = EVENT_TYPE_META[event as PostForMeEventType];
                        if (!meta) return null;
